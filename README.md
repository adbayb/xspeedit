...
- [Styleguide composants du package xspeedit-widget (react-styleguidist)](https://xspeedit-styleguide.surge.sh)
...
L'étape `Deploy` se charge de déployer [l'application web](https://xspeedit.surge.sh) ainsi que les documentations techniques ([JSDoc de la librairie](https://xspeedit-core.surge.sh/Packager.html) et [Styleguide des composants du widget](https://xspeedit-styleguide.surge.sh))

# Liens utiles

- [Application web](https://xspeedit.surge.sh)
- [Apis de la librairie xspeedit-core](https://xspeedit-core.surge.sh/Packager.html)
- [Styleguide des composants du package xspeedit-widget](https://xspeedit-styleguide.surge.sh)
